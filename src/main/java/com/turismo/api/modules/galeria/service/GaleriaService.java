...
// Modulo Galeria: agregar reglas de negocio de galeria solo en este servicio.
@Service
...
public class GaleriaService {
	...
	public Galeria buscarPorId(Long id) {
		return galeriaRepository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("Imagen de galeria no encontrada con id: " + id));
	}
